...
import SingleUserGuidesPage from "../components/app_components/UserGuidesPage/SingleUserGuidesPage";
import UserGuideProjectLayoutPage from "../components/app_components/UserGuidesPage/UserGuideProjectLayoutPage";
//  ~cb-add-import~
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute redirectPath={"/login"} />}>
        ...
        />
<Route path="/userGuides/:singleUserGuidesId" exact element={<SingleUserGuidesPage />} />
<Route path="/userGuides" exact element={<UserGuideProjectLayoutPage />} />
