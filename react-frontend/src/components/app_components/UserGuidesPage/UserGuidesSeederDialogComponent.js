...
import seederData from "./userGuides.seeder.json";
...
const UserGuidesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserGuidesSeederDialogComponent);
